...
if page == "Home":
    ...
    stress_level = st.number_input("Enter your stress level (1-10)", min_value=1, max_value=10)
    workplace = st.text_input("Where are you working?")
    role = st.text_input("What role are you playing?")
    salary = st.number_input("Enter your salary (in Rs)", min_value=0.0)
